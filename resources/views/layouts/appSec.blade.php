...
<body>
    <div id="app">
        ...
        <nav class="py-6 px-96 bg-white flex items-center justify-between mb-6">
            ...
            <div class="w-2/5">
                <input type="text" value="" class="px-4 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:ring-opacity-50 focus:border-blue-400 w-full bg-white text-gray-200 border-2 border-gray-200 rounded-lg" placeholder="Search">
            </div>
            <ul class="flex items-center">
                @auth
                <li>
